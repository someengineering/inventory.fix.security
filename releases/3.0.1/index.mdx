...
- [`1fc68807`](https://github.com/someengineering/resoto/commit/1fc68807) Add the actual error message that AWS returns (#1342)
...
- [`31a8a420`](https://github.com/someengineering/resoto/commit/31a8a420) Remove resoto bundle (#1349)
- [`c2bff20a`](https://github.com/someengineering/resoto/commit/c2bff20a) Bump 3.0.1 (#1334)
