...
- [How to Collect Kubernetes Resource Data](/how-to-guides/data-sources/collect-kubernetes-resource-data)
- [Kubernetes Resource Data Models](/reference/unified-data-model/kubernetes)

### UI to Configure Resoto

We now ship a user interface (UI) in [Resoto Core](/reference/components/core), from which it is possible to configure Resoto.

If you are running Resoto locally via Docker, the UI is accessible via [https://localhost:8900/ui](https://localhost:8900/ui):
...
[Resoto Shell](/reference/components/shell) now provides better, type-aware suggestions:

![Complex Kind](./img/kind_is_complex.png)

[Resoto Shell](/reference/components/shell) is also able to suggest deeply nested properties, since it knows the complete model structure:
...
- A [Kubernetes node](/reference/unified-data-model/kubernetes#kubernetes_node) is running on an [AWS EC2 instance](/reference/unified-data-model/aws#aws_ec2_instance). The [Kubernetes collector](/how-to-guides/data-sources/collect-kubernetes-resource-data) is unable to resolve the reference, since it points to a resource provided by [AWS](/how-to-guides/data-sources/collect-aws-resource-data).

- A [load balancer in AWS](/reference/unified-data-model/aws#aws_alb) that points to [compute resources in Google Cloud](/reference/unified-data-model/google-cloud#gcp_instance). The [AWS collector](/how-to-guides/data-sources/collect-aws-resource-data) does not know anything about [Google Cloud](/how-to-guides/data-sources/collect-google-cloud-resource-data).
...
- [`9f97b56`](https://github.com/someengineering/resoto/commit/9f97b56) Remove trailing slash ([#905](https://github.com/someengineering/resoto/pull/905))
- [`941eaca`](https://github.com/someengineering/resoto/commit/941eaca) Outer edge collection support - Part 2/4 ([#892](https://github.com/someengineering/resoto/pull/892))
...
- [`ad42bd4`](https://github.com/someengineering/resoto/commit/ad42bd4) Add a package to install all resoto components at once ([#890](https://github.com/someengineering/resoto/pull/890))
...
- [`552feeb`](https://github.com/someengineering/resoto/commit/552feeb) Initial DNS support ([#894](https://github.com/someengineering/resoto/pull/894))
...
- [`3909d5b`](https://github.com/someengineering/resoto/commit/3909d5b) fix: resotolib/requirements.txt to reduce vulnerabilities ([#888](https://github.com/someengineering/resoto/pull/888))
...
- [`7e389ab`](https://github.com/someengineering/resoto/commit/7e389ab) Update git repo check in setup_venv script ([#910](https://github.com/someengineering/resoto/pull/910))
...
- [`c47a422`](https://github.com/someengineering/resoto/commit/c47a422) Build and push to PyPI on tag push ([#865](https://github.com/someengineering/resoto/pull/865))

### Chores

- [`4e64f64`](https://github.com/someengineering/resoto/commit/4e64f64) [resoto][chore] bump release version
- [`a516fbf`](https://github.com/someengineering/resoto/commit/a516fbf) [resoto][chore] Bump release version.
...
- [`799911f`](https://github.com/someengineering/resoto/commit/799911f) Move duration parsing from resotocore to resotolib ([#919](https://github.com/someengineering/resoto/pull/919))
- [`f26bd09`](https://github.com/someengineering/resoto/commit/f26bd09) Bump versions - take #2 ([#907](https://github.com/someengineering/resoto/pull/907))
- [`43ac678`](https://github.com/someengineering/resoto/commit/43ac678) Bump versions ([#906](https://github.com/someengineering/resoto/pull/906))
...
- [`e2f7a33`](https://github.com/someengineering/resoto/commit/e2f7a33) use 120 characters line length for everything ([#899](https://github.com/someengineering/resoto/pull/899))
- [`b2736cf`](https://github.com/someengineering/resoto/commit/b2736cf) Update README ([#867](https://github.com/someengineering/resoto/pull/867))
- [`637c4ee`](https://github.com/someengineering/resoto/commit/637c4ee) Bump 2.3.0a0 ([#864](https://github.com/someengineering/resoto/pull/864))
