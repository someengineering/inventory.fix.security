...
- [Kubernetes Resource Data Models](/reference/unified-data-model/k8s)
...
- A [Kubernetes node](/reference/unified-data-model/k8s) is running on an [AWS EC2 instance](/reference/unified-data-model/aws). The [Kubernetes collector](/how-to-guides/data-sources/collect-kubernetes-resource-data) is unable to resolve the reference, since it points to a resource provided by [AWS](/how-to-guides/data-sources/collect-aws-resource-data).

- A [load balancer in AWS](/reference/unified-data-model/aws) that points to [compute resources in Google Cloud](/reference/unified-data-model/gcp). The [AWS collector](/how-to-guides/data-sources/collect-aws-resource-data) does not know anything about [Google Cloud](/how-to-guides/data-sources/collect-google-cloud-resource-data).
