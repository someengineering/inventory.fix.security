...
- [`184e3a63`](https://github.com/someengineering/resoto/commit/184e3a63) Operation needs database instance as query param (#1510)
...
- [`0bad9931`](https://github.com/someengineering/resoto/commit/0bad9931) Bump 3.2.7 (#1499)
