...
- [`5a145e26`](https://github.com/someengineering/resoto/commit/5a145e26) Improve devcontainer build times and enable linters by default (#1484)
- [`28b4ac2e`](https://github.com/someengineering/resoto/commit/28b4ac2e) Bump 3.2.6 (#1476)
