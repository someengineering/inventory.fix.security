...
- [`94d7f6a6`](https://github.com/someengineering/fixinventory/commit/94d7f6a6) <span class="badge badge--secondary">fixcore</span> Migrate existing resoto data and configs (#1962)
- [`57a5a377`](https://github.com/someengineering/fixinventory/commit/57a5a377) <span class="badge badge--secondary">fix</span> more typos (#1960)
- [`ab21ad73`](https://github.com/someengineering/fixinventory/commit/ab21ad73) <span class="badge badge--secondary">fix</span> Update Fix -> FixInventory (#1957)
- [`782c8f5a`](https://github.com/someengineering/fixinventory/commit/782c8f5a) <span class="badge badge--secondary">fix</span> Update Fix -> FixInventory (#1955)
...
- [`111ed2af`](https://github.com/someengineering/fixinventory/commit/111ed2af) <span class="badge badge--secondary">feat</span> Introduce managed_kubernetes_cluster and clean up collect (#1939)
...
- [`293b3e75`](https://github.com/someengineering/fixinventory/commit/293b3e75) <span class="badge badge--secondary">fixlib</span> Make overrides backwards compatible (#1972)
- [`17098877`](https://github.com/someengineering/fixinventory/commit/17098877) <span class="badge badge--secondary">fixinventory</span> Ensure backwards compatibility (#1971)
- [`6aefe6f9`](https://github.com/someengineering/fixinventory/commit/6aefe6f9) <span class="badge badge--secondary">fixinventory</span> Use fixinventory instead of fix (#1970)
- [`7d348d65`](https://github.com/someengineering/fixinventory/commit/7d348d65) <span class="badge badge--secondary">fixinventory</span> Update core env prefix (#1969)
...
- [`1ddddd53`](https://github.com/someengineering/fixinventory/commit/1ddddd53) <span class="badge badge--secondary">fixinventory</span> Correct Badges (#1966)
...
- [`7066f4fb`](https://github.com/someengineering/fixinventory/commit/7066f4fb) <span class="badge badge--secondary">fixcore</span> Restore SVG (#1964)
- [`6ab2ad72`](https://github.com/someengineering/fixinventory/commit/6ab2ad72) <span class="badge badge--secondary">fixcore</span> Update logo (#1961)
- [`bf9bf8b3`](https://github.com/someengineering/fixinventory/commit/bf9bf8b3) <span class="badge badge--secondary">fixcore</span> Wait after stdout/stderr has been read (#1963)
- [`73f26fbe`](https://github.com/someengineering/fixinventory/commit/73f26fbe) <span class="badge badge--secondary">fixcore</span> Updated logo (#1959)
- [`debafe46`](https://github.com/someengineering/fixinventory/commit/debafe46) <span class="badge badge--secondary">fixinventory</span> remove dist folder (#1956)
- [`d4a41734`](https://github.com/someengineering/fixinventory/commit/d4a41734) <span class="badge badge--secondary">fixinventory</span> Update runuser (#1950)
...
- [`7025a928`](https://github.com/someengineering/fixinventory/commit/7025a928) <span class="badge badge--secondary">fixinventory</span> use correct secret name (#1947)
- [`3b081782`](https://github.com/someengineering/fixinventory/commit/3b081782) <span class="badge badge--secondary">fixinventory</span> do not publish resoto images (#1946)
- [`35e9718e`](https://github.com/someengineering/fixinventory/commit/35e9718e) <span class="badge badge--secondary">fixinventory</span> fix policy gen path (#1945)
- [`a497b4ff`](https://github.com/someengineering/fixinventory/commit/a497b4ff) <span class="badge badge--secondary">fixinventory</span> fix policy gen requirements (#1944)
- [`2393592c`](https://github.com/someengineering/fixinventory/commit/2393592c) <span class="badge badge--secondary">chore</span> Rename Resoto -> Fix (#1943)

### Chores

- [`a618166b`](https://github.com/someengineering/fixinventory/commit/a618166b) <span class="badge badge--secondary">fixinventory</span> Bump 4.0.0 (#1973)
- [`09db99ca`](https://github.com/someengineering/fixinventory/commit/09db99ca) <span class="badge badge--secondary">fixcore</span> Remove resoto-ui and show static HTML page instead. (#1965)
- [`d9105fb0`](https://github.com/someengineering/fixinventory/commit/d9105fb0) <span class="badge badge--secondary">fixinventory</span> Bump 4.0.0a4 (#1958)
- [`f70de397`](https://github.com/someengineering/fixinventory/commit/f70de397) <span class="badge badge--secondary">fixinventory</span> FixInventory -> Fix Inventory (#1952)
...
- [`d889d2e4`](https://github.com/someengineering/fixinventory/commit/d889d2e4) <span class="badge badge--secondary">fixinventory</span> Remove graph view (#1951)
- [`81b7c881`](https://github.com/someengineering/fixinventory/commit/81b7c881) <span class="badge badge--secondary">fixinventory</span> Bump 4.0.0a3 (#1949)
- [`8e306a10`](https://github.com/someengineering/fixinventory/commit/8e306a10) <span class="badge badge--secondary">fixinventory</span> Rename Docker components Resoto -> Fix Inventory (#1942)
- [`12024086`](https://github.com/someengineering/fixinventory/commit/12024086) <span class="badge badge--secondary">fixinventory</span> Bump 4.0.0 (#1935)
