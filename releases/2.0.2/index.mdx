...
- [`3eef30b`](https://github.com/someengineering/resoto/commit/3eef30b) add more script documentation ([#773](https://github.com/someengineering/resoto/pull/773))
...
- [`0282425`](https://github.com/someengineering/resoto/commit/0282425) Update rendering script docs ([#796](https://github.com/someengineering/resoto/pull/796))
- [`cdd3f5a`](https://github.com/someengineering/resoto/commit/cdd3f5a) Add the instruction for the graph rendering script ([#795](https://github.com/someengineering/resoto/pull/795))

### Chores

- [`e4aa797`](https://github.com/someengineering/resoto/commit/e4aa797) Bump 2.0.2
- [`2f1c040`](https://github.com/someengineering/resoto/commit/2f1c040) use version 2.0 as docker version in compose
- [`1763105`](https://github.com/someengineering/resoto/commit/1763105) Add documentation as release note section ([#792](https://github.com/someengineering/resoto/pull/792))
