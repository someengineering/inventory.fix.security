---
sidebar_label: Target gRPC Proxy
---
...
- Service: compute
- Provider Link: [Target gRPC Proxy](https://cloud.google.com/load-balancing/docs/target-grpc-proxy)
...
```kroki imgType="plantuml" imgAlt="Hierarchy of Target gRPC Proxy"
@startuml
hide empty members
...
```kroki imgType="plantuml" imgAlt="Diagram of Target gRPC Proxy resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
```kroki imgType="plantuml" imgAlt="Diagram of Target gRPC Proxy data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
