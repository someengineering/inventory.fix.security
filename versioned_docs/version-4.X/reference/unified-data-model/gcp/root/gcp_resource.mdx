...
- Provider Link: [Resource](https://cloud.google.com/docs)

## Description

A GCP Resource is a specific instance of a service or component within Google Cloud Platform. It represents a unit of cloud infrastructure or functionality, such as a virtual machine, storage bucket, or database. GCP Resources are created, managed, and organized to build and operate cloud-based applications and services on the Google Cloud Platform.
