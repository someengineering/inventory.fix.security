...
- Service: cloudfront
- Provider Link: [CloudFront Streaming Distribution](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-rtmp.html)
...
```kroki imgType="plantuml" imgAlt="Hierarchy of CloudFront Streaming Distribution"
@startuml
hide empty members
...
```kroki imgType="plantuml" imgAlt="Diagram of CloudFront Streaming Distribution resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
```kroki imgType="plantuml" imgAlt="Diagram of CloudFront Streaming Distribution data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
