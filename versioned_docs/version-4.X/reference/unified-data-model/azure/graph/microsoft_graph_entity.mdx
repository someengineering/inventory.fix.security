...
```kroki imgType="plantuml" imgAlt="Hierarchy of Graph Entity"
@startuml
hide empty members
...
```kroki imgType="plantuml" imgAlt="Diagram of Graph Entity resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
```kroki imgType="plantuml" imgAlt="Diagram of Graph Entity data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
