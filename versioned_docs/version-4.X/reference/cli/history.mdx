...
Whenever changes are detected by Fix Inventory, a dedicated change event is written as separate entity. Following changes are supported:
...
The current implementation only maintains the history of [nodes](../../concepts/asset-inventory-graph/index.mdx#nodes), not [edges](../../concepts/asset-inventory-graph/index.mdx#edges).
