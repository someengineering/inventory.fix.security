...
Cleanup can be performed manually in [Fix Inventory Shell](../../reference/components/shell.mdx), automatically using a [cleanup plugin](../../reference/components/plugins/index.mdx), or via a scheduled [job](../automation/index.mdx#jobs).
