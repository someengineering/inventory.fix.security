...
![Job Overview](./img/jobs-intro.png)
...
See [Events](../../reference/events/index.mdx) for a list of events emitted by Fix Inventory.
...
Jobs are persisted in the Fix Inventory database. The [`job` command](../../reference/cli/job/index.mdx) allows you to [add](../../reference/cli/job/add.mdx), [update](../../reference/cli/job/update.mdx), [delete](../../reference/cli/job/delete.mdx), and [list](../../reference/cli/job/list.mdx) jobs.
