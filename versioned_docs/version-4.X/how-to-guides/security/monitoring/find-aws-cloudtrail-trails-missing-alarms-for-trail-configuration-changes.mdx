---
sidebar_label: Find AWS CloudTrail Trails Missing Alarms for Trail Configuration Changes
---

# How to Find AWS CloudTrail Trails Missing Alarms for Trail Configuration Changes
