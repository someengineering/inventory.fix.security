...
[Jobs](../../concepts/automation/index.mdx) allow you to define automations in Fix Inventory and can be triggered by the [events](../../reference/events/index.mdx) emitted by the [`collect_and_cleanup` workflow](../../reference/workflows/index.mdx#collect_and_cleanup-workflow).
