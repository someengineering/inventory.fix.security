...
[Jobs](../../concepts/automation/index.mdx) allow you to define automations in Fix Inventory and can be triggered on a regular schedule after [`collect_and_cleanup` workflow](../../reference/workflows/index.mdx#collect_and_cleanup-workflow) steps fire [events](../../reference/events/index.mdx).
