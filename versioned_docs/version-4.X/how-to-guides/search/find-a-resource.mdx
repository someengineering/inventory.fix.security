...
1. Execute the [`search` command](../../reference/cli/search.mdx) in [Fix Inventory Shell](../../reference/components/shell.mdx) with your search term in double quotes:
...
2. To view resource details, use the [`dump` command](../../reference/cli/dump.mdx):
...
- [Unified Data Model](../../reference/unified-data-model/index.mdx)
