...
Check out the [Fix Inventory Apps git repository](https://github.com/someengineering/fixinventory-apps) for a list of apps.

Using [`resotoappbundler`](https://github.com/someengineering/fixinventoryappbundler) (`pip install resotoappbundler`) you can bundle and dry-run (using `resotoapprunner`) your app locally.
...
4.  Check out the [`resoto-apps` GitHub repository](https://github.com/someengineering/fixinventory-apps):
