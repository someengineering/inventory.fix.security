...
To tag resources, simply pipe the result of a [search](../../reference/search/index.mdx) into the [`tag` command](../../reference/cli/tag/index.mdx).
...
When a resource is tagged on the [Fix Inventory Shell](../../reference/components/shell.mdx), [Fix Inventory Core](../../reference/components/core.mdx) creates a tagging task that is dispatched to a [Worker](../../reference/components/worker.mdx).
...
- [How to Find Untagged Resources](../../how-to-guides/search/find-untagged-resources.mdx)
