...
Cleanup can be performed manually in [Fix Inventory Shell](../../reference/components/shell.mdx), automatically using the [`cleanup_expired` plugin](../../reference/components/plugins/cleanup_expired.mdx), or via a scheduled [job](../automation/index.mdx#jobs).
...
| ----------------------------------- | ------------------------------------------------------------------------ | --------------------------- |
| `resoto:expires`                    | [ISO 8601](https://iso.org/iso-8601-date-and-time-format.html) timestamp | `2022-09-21T10:40:11+00:00` |
