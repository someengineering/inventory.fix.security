---
sidebar_label: Unified Resources
sidebar_position: 1
---

# Common cloud provider resources

This page lists common cloud provider abstractions available in Fix Inventory with the specific resources that are available for each of them. It is possible to search resources across cloud providers using one of the provided abstractions and the related properties.
