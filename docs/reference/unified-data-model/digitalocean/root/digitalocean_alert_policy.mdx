...
A DigitalOcean Alert Policy.

## Base Hierarchy

<ZoomPanPinch>

```kroki imgType="plantuml" imgAlt="Hierarchy of Alert Policy"
@startuml
hide empty members
...
```kroki imgType="plantuml" imgAlt="Diagram of Alert Policy resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
```kroki imgType="plantuml" imgAlt="Diagram of Alert Policy data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
