...
DigitalOcean App is a platform that allows users to deploy and manage applications on DigitalOcean's cloud infrastructure.

## Base Hierarchy

<ZoomPanPinch>

```kroki imgType="plantuml" imgAlt="Hierarchy of App"
@startuml
hide empty members
...
```kroki imgType="plantuml" imgAlt="Diagram of App resource relationships"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
...
```kroki imgType="plantuml" imgAlt="Diagram of App data model"
@startuml
hide empty members
skinparam ArrowColor #ffaf37
skinparam ArrowFontColor #ffaf37
