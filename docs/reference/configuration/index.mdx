...
```bash
  $ export RESOTOCORE_OVERRIDE=fixcore.api.web_hosts=127.0.0.1,10.0.0.1
```
...
<abbr title="JavaScript Object Notation">JSON</abbr>-format logging can be disabled via the `RESOTO_LOG_TEXT` environment variable:
