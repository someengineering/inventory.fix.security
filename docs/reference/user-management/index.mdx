...
[Fix Inventory Shell](../components/shell.mdx) is protected by a login screen that requires a username and password:
...
Session durations default to one hour. This duration is configurable in [Fix Inventory Core](../components/core.mdx).
