...
Every [edge](../../concepts/asset-inventory-graph/index.mdx#edges) has a type which defines the relationship between two [nodes](../../concepts/asset-inventory-graph/index.mdx#nodes).
...
| ------------------------------------------------------ | ------------------- |
| [`predecessors`](../../reference/cli/predecessors.mdx) | `<--` or `<-[1:1]-` |
| [`successors`](../../reference/cli/successors.mdx)     | `-->` or `-[1:1]->` |
| [`ancestors`](../../reference/cli/ancestors.mdx)       | `<-[1:]-`           |
| [`descendants`](../../reference/cli/descendants.mdx)   | `-[1:]->`           |
