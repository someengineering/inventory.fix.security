...
The Fix Inventory CLI offers a variety of commands that allow you to interact with Fix Inventory via [Fix Inventory Shell](../components/shell.mdx).
...
| [`user`](./user/index.mdx)         | Access and manage Fix Inventory users    |
