...
The `graph` command is part of the Fix Inventory Rewind module and allows for the management of [asset inventory graph](../../../concepts/asset-inventory-graph/index.mdx) snapshots.
...
| [`graph snapshot`](./snapshot.mdx) | Create an [asset inventory graph](../../../concepts/asset-inventory-graph/index.mdx) snapshot |
