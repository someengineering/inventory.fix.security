...
See [How to Roll Out Fix Inventory AWS Permissions with CloudFormation](../../how-to-guides/configuration/roll-out-aws-permissions-with-cloudformation/index.mdx) for step-by-step directions on how to use the template.
