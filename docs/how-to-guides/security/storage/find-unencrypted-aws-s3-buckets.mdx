...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/dump.mdx):
   ...
   The command output will list the details of all non-compliant [`aws_s3_bucket` resources](../../../reference/unified-data-model/aws/s3/aws_s3_bucket.mdx).
...
- [`aws_s3_bucket` Resource Data Model](../../../reference/unified-data-model/aws/s3/aws_s3_bucket.mdx)
