...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/dump.mdx):
   ...
   The command output will list the details of all non-compliant [`aws_apigateway_stage` resources](../../../reference/unified-data-model/aws/apigateway/aws_apigateway_stage.mdx).
...
- [`aws_apigateway_stage` Resource Data Model](../../../reference/unified-data-model/aws/apigateway/aws_apigateway_stage.mdx)
