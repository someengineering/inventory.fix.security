...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/dump.mdx):
   ...
   The command output will list the details of all non-compliant [`aws_ec2_network_acl` resources](../../../reference/unified-data-model/aws/ec2/aws_ec2_network_acl.mdx).
...
- [`aws_ec2_network_acl` Resource Data Model](../../../reference/unified-data-model/aws/ec2/aws_ec2_network_acl.mdx)
