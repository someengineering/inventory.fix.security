...
2. Pipe the `search` command into the [`dump` command](../../../reference/cli/dump.mdx):
   ...
   The command output will list the details of all non-compliant [`aws_vpc` resources](../../../reference/unified-data-model/aws/ec2/aws_vpc.mdx).
...
- [`aws_vpc` Resource Data Model](../../../reference/unified-data-model/aws/ec2/aws_vpc.mdx)
