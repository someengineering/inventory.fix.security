...
If you prefer to deploy the StackSet yourself, you can download the template from our CDN: [https://cdn.some.engineering/fix/aws/latest/fixinventory-role.template](https://cdn.some.engineering/fix/aws/latest/fixinventory-role.template).
